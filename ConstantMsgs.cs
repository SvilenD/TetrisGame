namespace TetrisGame
{
    internal static class ConstantMsgs
    {
        ...
        internal const string GamePaused = "Game Paused \r\n Press Esc to continue";
        internal const string GameOver = "Game Over!";
        internal const string Exit = "Press Space to Exit";
        internal const string FinalScore = "Score: {0}";
    }
}